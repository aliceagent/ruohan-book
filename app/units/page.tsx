    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-muted-foreground">
          The book has 22 units and 120 situations. Unit 1 is fully built with pinyin, English,
          vocabulary, and questions. Later units are listed so the site can grow lesson by lesson.
        </p>
      </div>
